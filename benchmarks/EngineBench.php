...
use Benchmarks\Support\ArraySource;
use Benchmarks\Support\ExpandedOrdersSchema;
...
final class EngineBench
{
    ...
    /** @var \Benchmarks\Support\MixedSchema The mixed scalar schema. */
    private MixedSchema $mixedSchema;

    /** @var \Benchmarks\Support\ExpandedOrdersSchema The row-expansion schema. */
